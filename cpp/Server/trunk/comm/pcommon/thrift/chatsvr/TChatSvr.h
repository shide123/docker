...
class TChatSvrIf {
 public:
  ...
  virtual bool proc_commentAudit(const TChatAuditMsg& tTChatMsg) = 0;
};
...
typedef struct _TChatSvr_proc_commentAudit_args__isset {
  _TChatSvr_proc_commentAudit_args__isset() : tTChatMsg(false) {}
  bool tTChatMsg :1;
} _TChatSvr_proc_commentAudit_args__isset;

class TChatSvr_proc_commentAudit_args {
 public:

  TChatSvr_proc_commentAudit_args(const TChatSvr_proc_commentAudit_args&);
  TChatSvr_proc_commentAudit_args& operator=(const TChatSvr_proc_commentAudit_args&);
  TChatSvr_proc_commentAudit_args() {
  }

  virtual ~TChatSvr_proc_commentAudit_args() throw();
  TChatAuditMsg tTChatMsg;

  _TChatSvr_proc_commentAudit_args__isset __isset;

  void __set_tTChatMsg(const TChatAuditMsg& val);

  bool operator == (const TChatSvr_proc_commentAudit_args & rhs) const
  {
    if (!(tTChatMsg == rhs.tTChatMsg))
      return false;
    return true;
  }
  bool operator != (const TChatSvr_proc_commentAudit_args &rhs) const {
  ...
  bool operator < (const TChatSvr_proc_commentAudit_args & ) const;
...
class TChatSvr_proc_commentAudit_pargs {
 public:


  virtual ~TChatSvr_proc_commentAudit_pargs() throw();
  const TChatAuditMsg* tTChatMsg;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _TChatSvr_proc_commentAudit_result__isset {
  _TChatSvr_proc_commentAudit_result__isset() : success(false) {}
  bool success :1;
} _TChatSvr_proc_commentAudit_result__isset;

class TChatSvr_proc_commentAudit_result {
 public:

  TChatSvr_proc_commentAudit_result(const TChatSvr_proc_commentAudit_result&);
  TChatSvr_proc_commentAudit_result& operator=(const TChatSvr_proc_commentAudit_result&);
  TChatSvr_proc_commentAudit_result() : success(0) {
  }

  virtual ~TChatSvr_proc_commentAudit_result() throw();
  bool success;

  _TChatSvr_proc_commentAudit_result__isset __isset;

  void __set_success(const bool val);

  bool operator == (const TChatSvr_proc_commentAudit_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TChatSvr_proc_commentAudit_result & ) const;
...
typedef struct _TChatSvr_proc_commentAudit_presult__isset {
  _TChatSvr_proc_commentAudit_presult__isset() : success(false) {}
  bool success :1;
} _TChatSvr_proc_commentAudit_presult__isset;

class TChatSvr_proc_commentAudit_presult {
 public:


  virtual ~TChatSvr_proc_commentAudit_presult() throw();
  bool* success;

  _TChatSvr_proc_commentAudit_presult__isset __isset;
...
class TChatSvrClient : virtual public TChatSvrIf {
 ...
 public:
  ...
  bool proc_commentAudit(const TChatAuditMsg& tTChatMsg);
  void send_proc_commentAudit(const TChatAuditMsg& tTChatMsg);
  bool recv_proc_commentAudit();
 protected:
...
class TChatSvrProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_proc_commentAudit(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  TChatSvrProcessor(boost::shared_ptr<TChatSvrIf> iface) :
    ...
    processMap_["proc_commentAudit"] = &TChatSvrProcessor::process_proc_commentAudit;
  }
...
class TChatSvrMultiface : virtual public TChatSvrIf {
 ...
 public:
  ...
  bool proc_commentAudit(const TChatAuditMsg& tTChatMsg) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->proc_commentAudit(tTChatMsg);
    }
    return ifaces_[i]->proc_commentAudit(tTChatMsg);
  }
...
class TChatSvrConcurrentClient : virtual public TChatSvrIf {
 ...
 public:
  ...
  bool proc_commentAudit(const TChatAuditMsg& tTChatMsg);
  int32_t send_proc_commentAudit(const TChatAuditMsg& tTChatMsg);
  bool recv_proc_commentAudit(const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
...
class TChatSvrCobClIf {
 public:
  ...
  virtual void proc_commentAudit(tcxx::function<void(TChatSvrCobClient* client)> cob, const TChatAuditMsg& tTChatMsg) = 0;
};
...
class TChatSvrCobSvIf {
 public:
  ...
  virtual void proc_commentAudit(tcxx::function<void(bool const& _return)> cob, const TChatAuditMsg& tTChatMsg) = 0;
};
...
class TChatSvrCobClient : virtual public TChatSvrCobClIf {
 public:
  ...
  void send_proc_optPPTPic(const std::vector<TPPTPicInfo> & vecPicId, const int32_t optType);
  bool recv_proc_optPPTPic();
  void proc_commentAudit(tcxx::function<void(TChatSvrCobClient* client)> cob, const TChatAuditMsg& tTChatMsg);
  void send_proc_commentAudit(const TChatAuditMsg& tTChatMsg);
  bool recv_proc_commentAudit();
 protected:
...
class TChatSvrAsyncProcessor : public ::apache::thrift::async::TAsyncDispatchProcessor {
 ...
 private:
  ...
  void process_proc_commentAudit(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_proc_commentAudit(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_proc_commentAudit(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  TChatSvrAsyncProcessor(boost::shared_ptr<TChatSvrCobSvIf> iface) :
    ...
    processMap_["proc_commentAudit"] = &TChatSvrAsyncProcessor::process_proc_commentAudit;
  }
