 ...
 */
int SL_Random::randomInteger()
{
	return ::rand();
}

int SL_Random::randomInteger(int low, int high)
{
	if (high < low)
	{
		int tmp = high;
 ...
 */
double SL_Random::randomReal()
{
	return (double) (::rand() / ((double)RAND_MAX + 1));
}

double SL_Random::randomReal(double low, double high)
{
	if (high < low)
	{
		double tmp = high;
 ...
 */
bool SL_Random::randomChance(double p)
{
