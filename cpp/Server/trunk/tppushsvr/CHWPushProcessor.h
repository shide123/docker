...
#ifndef __CHWPUSH_PROCESSOR_H__
#define __CHWPUSH_PROCESSOR_H__
...
using namespace std;
const string nsp_svc ="openpush.message.psBatchSend";// "openpush.message.psSingleSend";//
class CHWPushProcessor
{
public:
    ...
    bool Init(Config &cfg, const char* Main = "HWPush");
