...
int HttpServer::start_sync() {
	...
	_client_epoll_socket.set_backlog(_backlog);
	_client_epoll_socket.set_max_events(_max_events);
	_client_epoll_socket.set_watcher(&node_handler);
	_client_epoll_socket.start_client();
