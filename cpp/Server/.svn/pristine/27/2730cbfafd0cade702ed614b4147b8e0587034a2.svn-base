        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->vecPicId.resize(_size10);
            uint32_t _i14;
            for (_i14 = 0; _i14 < _size10; ++_i14)
            {
              xfer += this->vecPicId[_i14].read(iprot);
            }
...
uint32_t TChatSvr_proc_optPPTPic_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("vecPicId", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<TPPTPicInfo> ::const_iterator _iter15;
    for (_iter15 = this->vecPicId.begin(); _iter15 != this->vecPicId.end(); ++_iter15)
    {
...
uint32_t TChatSvr_proc_optPPTPic_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->vecPicId)).size()));
    std::vector<TPPTPicInfo> ::const_iterator _iter16;
    for (_iter16 = (*(this->vecPicId)).begin(); _iter16 != (*(this->vecPicId)).end(); ++_iter16)
    {
...
TChatSvr_proc_commentAudit_args::~TChatSvr_proc_commentAudit_args() throw() {
}


uint32_t TChatSvr_proc_commentAudit_args::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->tTChatMsg.read(iprot);
          this->__isset.tTChatMsg = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TChatSvr_proc_commentAudit_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TChatSvr_proc_commentAudit_args");

  xfer += oprot->writeFieldBegin("tTChatMsg", ::apache::thrift::protocol::T_STRUCT, 1);
  xfer += this->tTChatMsg.write(oprot);
  xfer += oprot->writeFieldEnd();
...
TChatSvr_proc_commentAudit_pargs::~TChatSvr_proc_commentAudit_pargs() throw() {
}


uint32_t TChatSvr_proc_commentAudit_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TChatSvr_proc_commentAudit_pargs");
...
TChatSvr_proc_commentAudit_result::~TChatSvr_proc_commentAudit_result() throw() {
}


uint32_t TChatSvr_proc_commentAudit_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TChatSvr_proc_commentAudit_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("TChatSvr_proc_commentAudit_result");
...
TChatSvr_proc_commentAudit_presult::~TChatSvr_proc_commentAudit_presult() throw() {
}


uint32_t TChatSvr_proc_commentAudit_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TChatSvr_proc_commentAudit_presult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TChatSvr_proc_commentAudit_presult");
...
bool TChatSvrClient::proc_commentAudit(const TChatAuditMsg& tTChatMsg)
{
  send_proc_commentAudit(tTChatMsg);
  return recv_proc_commentAudit();
}

void TChatSvrClient::send_proc_commentAudit(const TChatAuditMsg& tTChatMsg)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("proc_commentAudit", ::apache::thrift::protocol::T_CALL, cseqid);

  TChatSvr_proc_commentAudit_pargs args;
...
bool TChatSvrClient::recv_proc_commentAudit()
{
  ...
  if (fname.compare("proc_commentAudit") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  bool _return;
  TChatSvr_proc_commentAudit_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "proc_commentAudit failed: unknown result");
}
...
void TChatSvrProcessor::process_proc_commentAudit(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("TChatSvr.proc_commentAudit", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "TChatSvr.proc_commentAudit");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "TChatSvr.proc_commentAudit");
  }

  TChatSvr_proc_commentAudit_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "TChatSvr.proc_commentAudit", bytes);
  }

  TChatSvr_proc_commentAudit_result result;
  try {
    result.success = iface_->proc_commentAudit(args.tTChatMsg);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "TChatSvr.proc_commentAudit");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("proc_commentAudit", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "TChatSvr.proc_commentAudit");
  }

  oprot->writeMessageBegin("proc_commentAudit", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "TChatSvr.proc_commentAudit", bytes);
  }
}
...
bool TChatSvrConcurrentClient::proc_commentAudit(const TChatAuditMsg& tTChatMsg)
{
  int32_t seqid = send_proc_commentAudit(tTChatMsg);
  return recv_proc_commentAudit(seqid);
}

int32_t TChatSvrConcurrentClient::send_proc_commentAudit(const TChatAuditMsg& tTChatMsg)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("proc_commentAudit", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool TChatSvrConcurrentClient::recv_proc_commentAudit(const int32_t seqid)
{
...
void TChatSvrCobClient::proc_commentAudit(tcxx::function<void(TChatSvrCobClient* client)> cob, const TChatAuditMsg& tTChatMsg)
{
  send_proc_commentAudit(tTChatMsg);
  channel_->sendAndRecvMessage(tcxx::bind(cob, this), otrans_.get(), itrans_.get());
}

void TChatSvrCobClient::send_proc_commentAudit(const TChatAuditMsg& tTChatMsg)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("proc_commentAudit", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool TChatSvrCobClient::recv_proc_commentAudit()
{
...
void TChatSvrAsyncProcessor::process_proc_commentAudit(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  TChatSvr_proc_commentAudit_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("TChatSvr.proc_commentAudit", NULL);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "TChatSvr.proc_commentAudit");
  ...
  freer.unregister();
  void (TChatSvrAsyncProcessor::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return) =
    &TChatSvrAsyncProcessor::return_proc_commentAudit;
  iface_->proc_commentAudit(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx, tcxx::placeholders::_1),
      args.tTChatMsg);
}

void TChatSvrAsyncProcessor::return_proc_commentAudit(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return)
{
  TChatSvr_proc_commentAudit_presult result;
  result.success = const_cast<bool*>(&_return);
  result.__isset.success = true;
